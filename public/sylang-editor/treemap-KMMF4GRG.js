...
import { _ as __vitePreload } from "./main.js";
import { m as map$2, f as flatten$1, d as min } from "./min.js";
import { b as baseFlatten$1, l as baseUniq$1, d as baseIteratee$2, m as filter$1, r as reduce$1, n as forEach$2 } from "./_baseUniq.js";
import { b7 as isEmpty$1 } from "./mermaid.core.js";
function flatMap$1(collection, iteratee) {
  return baseFlatten$1(map$2(collection, iteratee));
}
function uniqBy(array2, iteratee) {
  return array2 && array2.length ? baseUniq$1(array2, baseIteratee$2(iteratee)) : [];
}
...
var defineProperty$1 = function() {
  try {
    var func2 = getNative$1(Object, "defineProperty");
    func2({}, "", {});
    return func2;
  } catch (e) {
  }
}();
var baseSetToString$1 = !defineProperty$1 ? identity$1 : function(func2, string2) {
...
function baseFindIndex$1(array2, predicate, fromIndex, fromRight) {
  var length = array2.length, index = fromIndex + -1;
  while (++index < length) {
...
function baseIndexOf$1(array2, value, fromIndex) {
  return value === value ? strictIndexOf$1(array2, value, fromIndex) : baseFindIndex$1(array2, baseIsNaN$1, fromIndex);
}
...
function overRest$1(func2, start, transform) {
  start = nativeMax$4(start === void 0 ? func2.length - 1 : start, 0);
  return function() {
...
function baseRest$1(func2, start) {
  return setToString$1(overRest$1(func2, start, identity$1), func2 + "");
}
...
function initCloneArray(array2) {
  ...
  if (length && typeof array2[0] == "string" && hasOwnProperty$i.call(array2, "index")) {
...
function equalArrays$1(array2, other, bitmask, customizer, equalFunc, stack) {
...
function createAggregator(setter, initializer) {
  return function(collection, iteratee) {
    var func2 = isArray$1(collection) ? arrayAggregator : baseAggregator, accumulator = initializer ? initializer() : {};
    return func2(collection, setter, baseIteratee$1(iteratee), accumulator);
  };
}
...
function forEach$1(collection, iteratee) {
  var func2 = isArray$1(collection) ? arrayEach$1 : baseEach$1;
  return func2(collection, castFunction$1(iteratee));
}
...
function every$1(collection, predicate, guard) {
  var func2 = isArray$1(collection) ? arrayEvery$1 : baseEvery$1;
  return func2(collection, baseIteratee$1(predicate));
}
...
function filter(collection, predicate) {
  var func2 = isArray$1(collection) ? arrayFilter$1 : baseFilter;
  return func2(collection, baseIteratee$1(predicate));
}
...
function findIndex(array2, predicate, fromIndex) {
  ...
  return baseFindIndex$1(array2, baseIteratee$1(predicate), index);
}
...
function map$1(collection, iteratee) {
  var func2 = isArray$1(collection) ? arrayMap$1 : baseMap$1;
  return func2(collection, baseIteratee$1(iteratee));
}
...
function indexOf(array2, value, fromIndex) {
  ...
  var index = 0;
  return baseIndexOf$1(array2, value, index);
}
...
function reduce(collection, iteratee, accumulator) {
  ...
  return func2(collection, baseIteratee$1(iteratee), accumulator, initAccum, baseEach$1);
}
function reject(collection, predicate) {
  var func2 = isArray$1(collection) ? arrayFilter$1 : baseFilter;
  return func2(collection, negate(baseIteratee$1(predicate)));
}
...
function some$1(collection, predicate, guard) {
  var func2 = isArray$1(collection) ? arraySome$1 : baseSome$1;
  return func2(collection, baseIteratee$1(predicate));
}
var INFINITY$1 = 1 / 0;
...
function baseUniq(array2, iteratee, comparator) {
  var index = -1, includes2 = arrayIncludes, length = array2.length, isCommon = true, result = [], seen = result;
...
function map(collection, iteratee) {
  ...
  return func2(collection, baseIteratee(iteratee));
}
  ...
  constructor(lexerDefinition, config = DEFAULT_LEXER_CONFIG) {
    ...
    this.TRACE_INIT("Lexer Constructor", () => {
      ...
      if (!isEmpty(this.lexerDefinitionErrors) && !this.config.deferDefinitionErrorsHandling) {
        const allErrMessages = map$1(this.lexerDefinitionErrors, (error2) => {
...
function isRecognitionException(error2) {
  return includes$1(RECOGNITION_EXCEPTION_NAMES, error2.name);
}
  ...
  getAstNode(node, path) {
    ...
    return segments.reduce((previousValue, currentValue) => {
      ...
      if (propertyIndex > 0) {
        ...
        const array2 = previousValue[property2];
